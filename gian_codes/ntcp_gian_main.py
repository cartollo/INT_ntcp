...
from ntcp_gian_check_convergence import *
from ntcp_gian_create_data import *
from ntcp_gian_functions import *
from ntcp_gian_global_variables import *
from ntcp_gian_optimization_function import *
from ntcp_gian_treecode import *
from ntcp_gian_visualization_cl import *
...
results_jk = fit_model(data, N_jk = 100, p_jk=0.9) # Fits the model, using 1000 Jack-Knife iterations with 90% resampling 
